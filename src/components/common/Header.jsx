...
const Header = ({title}) => {
  return (
      ...
      <div className='flex justify-between px-4 pt-4 mx-auto max-w-7xl sm:px-6 lg:px-8'>
        <div>
        <h1 className='text-2xl font-semibold text-gray-700'>{title}</h1>    
        </div>
        <div className='flex justify-between'>
        <div className="inline-flex items-center justify-center p-2 bg-blue-500 rounded-full cursor-pointer">
